...
# The institution with which a student or instructor is affiliated
...
# This allows us to store additional information about the user without having to extend the base
# user model.
